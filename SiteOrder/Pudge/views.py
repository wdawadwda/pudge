...
from .models import PartnersModel, ClubsModel, TariffModel, ComputerSpecModel
...
class LoadAllClubData(generics.ListCreateAPIView):
  ...
  def get(self, request, *args, **kwargs):
    ...
    for element in clubData:
      ...
      serializer.is_valid(raise_exception=True)
      serializer.save()
    return Response({'data': ClubsFullSerializer(ClubsFullJsonModel.objects.all(), many=True).data})
