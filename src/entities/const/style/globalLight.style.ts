...
// export const backgroundColorSecond4 = "#BEBE0B";
// export const backgroundDisabled = "rgb(138, 138, 138)";
export const backgroundColor2 = "black";
...
export const textDisabledColor = "rgba(255, 255, 255, 0)";
